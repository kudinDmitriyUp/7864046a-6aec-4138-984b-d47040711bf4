...
export const metadata: Metadata = {
  ...
  description: "Award-winning restaurant featuring farm-to-table cuisine, seasonal menus, and intimate ambiance. Reserve your table now.",
  keywords: "restaurant, fine dining, farm to table, seasonal menu, reservations",
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "Savoria - Fine Dining Restaurant",
    description: "Experience culinary excellence with our seasonal menu and award-winning chefs",
    type: "website",
    siteName: "Savoria",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35ggfqwTaDTPV7ncegJJc94SZmR/uploaded-1763736769875-5zayqi3m.jpg",
  ...
  twitter: {
    ...
    title: "Savoria - Fine Dining Restaurant",
    description: "Award-winning farm-to-table dining experience",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35ggfqwTaDTPV7ncegJJc94SZmR/uploaded-1763736769875-5zayqi3m.jpg"],
  },
};
